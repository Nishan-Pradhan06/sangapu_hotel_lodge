...
/// Adds pattern-matching-related methods to [StatementsEvent].
extension StatementsEventPatterns on StatementsEvent {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>({TResult Function( _StatementEvent value)?  getStatement,required TResult orElse(),}){
final _that = this;
switch (_that) {
case _StatementEvent() when getStatement != null:
return getStatement(_that);case _:
  return orElse();
...
@optionalTypeArgs TResult map<TResult extends Object?>({required TResult Function( _StatementEvent value)  getStatement,}){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>({TResult? Function( _StatementEvent value)?  getStatement,}){
final _that = this;
switch (_that) {
case _StatementEvent() when getStatement != null:
return getStatement(_that);case _:
